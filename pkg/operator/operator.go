...
func (c ServiceCatalogControllerManagerOperator) sync() error {
	...
	case operatorapiv1.Unmanaged:
		...
		v1helpers.SetOperatorCondition(&operatorConfig.Status.Conditions, operatorapiv1.OperatorCondition{Type: operatorapiv1.OperatorStatusTypeDegraded, Status: operatorapiv1.ConditionFalse, Reason: "Unmanaged", Message: "the controller manager is in an unmanaged state, therefore no operator actions are failing."})
	...
	case operatorapiv1.Removed:
		...
		v1helpers.SetOperatorCondition(&operatorConfig.Status.Conditions, operatorapiv1.OperatorCondition{Type: operatorapiv1.OperatorStatusTypeDegraded, Status: operatorapiv1.ConditionFalse, Reason: "Removed", Message: ""})
